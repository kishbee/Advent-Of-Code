...
%%
if type == 1 %number of bags containing shiny gold
outVals = bagRecursion(bag,384,strs);
value = length(unique(outVals))-1 %count bags containing shiny gold

%%
else % count bags inside
value = insideBags(bag,384,strs)-1 %count inside bags
end
end
%%
